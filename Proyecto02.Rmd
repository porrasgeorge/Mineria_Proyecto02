...
dL <- dataLog2 %>% filter (year %in% c(2017, 2018, 2019))  %>% 
  select(-unbalance)
...
saveRDS(modelo, file = "models/modelo2017_2019(importanceVariables).modelo")
...
dL <- dataLog2 %>% filter (year == 2019) %>% 
  select(-unbalance, -minute, -year)
...
## Guardar el modelo en disco
saveRDS(modelo, file = "models/modelo2019_varRemoved1.modelo")
